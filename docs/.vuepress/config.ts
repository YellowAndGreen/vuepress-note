...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'YellowAndGreen/YellowAndGreen.github.io', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        '黄不盈 | <a href="https://github.com/yellowandgreen" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'YellowAndGreen', // GitHub仓库所有者
          admin: ['YellowAndGreen'], // 对仓库有写权限的人
